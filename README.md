...
|---|---|
| [ARCHITECTURE.md](./ARCHITECTURE.md) | Internal structure, data flow, integration points, configuration reference |
| [CONTRIBUTING.md](./CONTRIBUTING.md) | Development setup, test commands, commit conventions, release process |
| [docs/ADRs/](./docs/ADRs/) | Why things look the way they do — key decisions documented |
| [AGENTS.md](./AGENTS.md) | Agent-first context directory — read this first if you're an AI tool |
